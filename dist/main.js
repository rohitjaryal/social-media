var Nr = { exports: {} }, Ge = {}, yr = { exports: {} }, g = {};
/**
 * @license React
...
function Vt() {
  ...
  function K(n, s, h, C, _) {
    ...
    if (k)
      return k = n, _ = _(k), n = C === "" ? "." + G(k, 0) : C, oe(_) ? (h = "", n != null && (h = n.replace(we, "$&/") + "/"), K(_, s, h, "", function(W) {
        return W;
    ...
    if (k = 0, C = C === "" ? "." : C + ":", oe(n))
      ...
      for (n = w.call(n), T = 0; !(P = n.next()).done; )
        P = P.value, w = C + G(P, T++), k += K(P, s, h, w, _);
    else if (P === "object")
      ...
      function _e(e, r, a, o, i) {
        ...
        if (Fe(e))
          ...
          if (typeof Lr == "function") {
            var ut = e;
            Lr === ut.entries && (Me || ue("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Me = !0);
            for (var Nt = Lr.call(ut), it, Mt = 0; !(it = Nt.next()).done; )
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === re || e === Q || K || e === te || e === V || e === ee || G || e === Ie || Ce || Ue || we || typeof e == "object" && e !== null && (e.$$typeof === se || e.$$typeof === H || e.$$typeof === $ || e.$$typeof === Z || e.$$typeof === L || // This needs to include all possible module reference object
...
` + m[x].replace(" at new ", " at ");
    ...
    function Er(t, u) {
      if (typeof t.ref == "string" && me.current && u && me.current.stateNode !== u) {
        var c = G(me.current.type);
        je[c] || (I('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', G(me.current.type), t.ref), je[c] = !0);
      }
    }
    function ge(t, u) {
      {
    ...
    function or(t, u) {
      {
        ...
        ar[c] = !0;
        var f = "";
        t && t._owner && t._owner !== Me.current && (f = " It was passed a child from " + G(t._owner.type) + "."), ve(t), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, f), ve(null);
      }
    }
    function ur(t, u) {
      {
    ...
    function ze(t, u, c, f, R, S) {
      {
        ...
        if (!b) {
          ...
          Y ? m += Y : m += xe();
          var x;
          t === null ? x = "null" : Le(t) ? x = "array" : t !== void 0 && t.$$typeof === y ? (x = "<" + (G(t.type) || "Unknown") + " />", m = " Did you accidentally export a JSX literal instead of a component?") : x = typeof t, I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", x, m);
        }
        var F = Cr(t, u, c, R, S);
        if (F == null)
          return F;
...
var zt = Nr.exports;
function qt() {
  return zt.jsx("div", { children: "this is dummy component" });
}
const Gt = () => {
};
var Mr;
(function(z) {
  z.SMALL = "small", z.LARGE = "large";
})(Mr || (Mr = {}));
const Ht = Mr;
console.log("hello");
export {
